...
@implementation ObjCMutableArrayHeap
...
{
    return [NSString stringWithFormat:@"<ObjCMutableArrayHeap with %d elements: %@>", self.size, [self.tree componentsJoinedByString:@", "]];
}
